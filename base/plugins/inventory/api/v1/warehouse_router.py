...
@router.get("/{warehouse_id}", response_model=StockWarehouseResponse, summary="获取仓库详情")
...
@router.post("", response_model=StockWarehouseResponse, summary="创建仓库")
...
@router.put("/{warehouse_id}", response_model=StockWarehouseResponse, summary="更新仓库")
...
@router.delete("/{warehouse_id}", response_model=MessageResponse, summary="删除仓库")
...
@router.get("", response_model=ListResponse, summary="获取仓库列表")
