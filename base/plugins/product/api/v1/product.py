...
@product_router.get("/attributes", summary="获取属性列表")
...
@product_router.get("/attributes/options", summary="获取属性选项")
...
@product_router.get("/attributes/{attr_id}", summary="获取属性详情")
...
@product_router.post("/attributes", summary="创建属性")
...
@product_router.put("/attributes/{attr_id}", summary="更新属性")
...
@product_router.delete("/attributes/{attr_id}", summary="删除属性")
...
@product_router.get("/attributes/{attr_id}/values", summary="获取属性值列表")
