...
base_data_router_router = APIRouter(prefix="/base-data", tags=["基础数据管理"])

@base_data_router_router.get("/materials/{material_id}", response_model=MaterialResponse)
...
@base_data_router_router.post("/materials", response_model=MaterialResponse)
...
@base_data_router_router.put("/materials/{material_id}", response_model=MaterialResponse)
...
@base_data_router_router.delete("/materials/{material_id}")
...
@base_data_router_router.get("/materials", response_model=ListResponse[MaterialResponse])
...
@base_data_router_router.get("/boms/{bom_id}", response_model=BomResponse)
...
@base_data_router_router.post("/boms", response_model=BomResponse)
async def create_bom(data: BomCreate):
    bom = await BomService.create_bom(data)
    return bom

@base_data_router_router.put("/boms/{bom_id}", response_model=BomResponse)
...
@base_data_router_router.delete("/boms/{bom_id}")
...
@base_data_router_router.get("/boms", response_model=ListResponse[BomResponse])
async def list_boms(
    page: int = 1,
    page_size: int = 10,
...
@base_data_router_router.get("/work-centers/{wc_id}", response_model=WorkCenterResponse)
...
@base_data_router_router.post("/work-centers", response_model=WorkCenterResponse)
...
@base_data_router_router.put("/work-centers/{wc_id}", response_model=WorkCenterResponse)
...
@base_data_router_router.delete("/work-centers/{wc_id}")
...
@base_data_router_router.get("/work-centers", response_model=ListResponse[WorkCenterResponse])
...
@base_data_router_router.get("/processes/{process_id}", response_model=ProcessResponse)
...
@base_data_router_router.post("/processes", response_model=ProcessResponse)
...
@base_data_router_router.put("/processes/{process_id}", response_model=ProcessResponse)
...
@base_data_router_router.delete("/processes/{process_id}")
...
@base_data_router_router.get("/processes", response_model=ListResponse[ProcessResponse])
...
@base_data_router_router.get("/routes/{route_id}", response_model=RouteResponse)
...
@base_data_router_router.post("/routes", response_model=RouteResponse)
...
@base_data_router_router.put("/routes/{route_id}", response_model=RouteResponse)
...
@base_data_router_router.delete("/routes/{route_id}")
...
@base_data_router_router.get("/routes", response_model=ListResponse[RouteResponse])
