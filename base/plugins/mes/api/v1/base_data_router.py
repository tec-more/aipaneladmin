...
@router.get("/materials", response_model=ListResponse[MaterialResponse])
...
@router.get("/boms", response_model=ListResponse[BomResponse])
async def list_boms(
    page: int = 1,
    page_size: int = 10,
...
@router.get("/work-centers", response_model=ListResponse[WorkCenterResponse])
...
@router.get("/processes", response_model=ListResponse[ProcessResponse])
...
@router.get("/routes", response_model=ListResponse[RouteResponse])
